                          ...
                          <div id="panelsStayOpen-collapseOne" class="accordion-collapse collapse show" aria-labelledby="panelsStayOpen-headingOne">
                            <div class="accordion-body">
                                <div class="row justify-content-between pb-3">
                                  <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="id_kamar" class="form-label">Nama</label>
                                        <input type="text" class="form-control" id="id_kamar" disabled value="{{ $pembayaran->kamar->nama_penghuni }}">
                                        @error('id_kamar')
                                  ...
                                  <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="id_kamar" disabled value="{{ $pembayaran->kamar->nama_kamar}}">
                                            @error('id_kamar')
                                              <div class="invalid-feedback">
                                                {{ $message }}
                                              </div>
